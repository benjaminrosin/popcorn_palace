...
## Technical Aspects
The system is built using TypeScript and NestJS, leveraging its robust framework for creating RESTful APIs. Data managed using an in-memory database using SQLITE with Sequelize lib.
